...
new class extends Component
{
    ...
    public function delete($id)
    {
        ...
        $this->dispatch('toast', message: 'Proprietário deletado com sucesso', type: 'success');
    }

    public function getVehicleOwnersProperty()
    {
        $query = VehicleOwner::latest();
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($this->vehicleOwners as $vehicleOwner)
                                <tr>
                                    ...
                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                        {{ $vehicleOwner->created_at->format('d/m/Y H:i') }}
                                    </td>
                ...
                <div class="sm:hidden divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach($this->vehicleOwners as $vehicleOwner)
                        <div class="p-4">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400 mb-3">Criado: {{ $vehicleOwner->created_at->format('d/m/Y H:i') }}</div>
