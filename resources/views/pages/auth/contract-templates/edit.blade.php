...
new class extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->title = $this->contractTemplate->title;
        $this->template = $this->contractTemplate->template;
    }
    ...
    public function update()
    {
        $this->validate([
            ...
            'template.required' => 'O template é obrigatório.',
        ]);

        $this->contractTemplate->update([
            'title' => $this->title,
        ...
        return $this->redirect(route('contractTemplates.index'), navigate: true);
    }
}
?>
...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center h-auto sm:h-16 py-3 sm:py-0 gap-3 sm:gap-0">
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                    ...
                    <a href="{{ route('contractTemplates.index') }}" class="text-sm sm:text-base text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100" wire:navigate>Templates de Contrato</a>
                    <span class="hidden sm:inline text-gray-400 dark:text-gray-600">|</span>
    ...
    <main class="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-6">Editar Template de Contrato</h1>
            ...
            <form wire:submit="update">
                <div class="border border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 mb-6">
                    ...
                    <div>
                        <label for="templateEditor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Template</label>
                        <x-tiptap-editor :initialContent="$template" />
                        @error('template')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                    ...
                    <a
                        href="{{ route('contractTemplates.index') }}"
