...
new class extends Component
{
    ...
    public ?string $vehicleBrandId = null;

    public function mount($id)
    {
        $this->vehicleModel = VehicleModel::findOrFail($id);
        $this->title = $this->vehicleModel->title;
        $this->vehicleBrandId = (string) $this->vehicleModel->vehicle_brand_id;
    }
    ...
    public function update()
    {
        $this->validate([
            ...
            'vehicleBrandId.required' => 'A marca é obrigatória.',
        ]);

        $this->vehicleModel->update([
            'title' => $this->title,
            'vehicle_brand_id' => $this->vehicleBrandId,
        ]);
        ...
        return $this->redirect(route('vehicleModels.index'), navigate: true);
    }

    public function getVehicleBrandsProperty()
    {
        return VehicleBrand::orderBy('title')->get();
    }
}
?>
...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center h-auto sm:h-16 py-3 sm:py-0 gap-3 sm:gap-0">
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                    ...
                    <a href="{{ route('vehicleModels.index') }}" class="text-sm sm:text-base text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100" wire:navigate>Modelos</a>
                    <span class="hidden sm:inline text-gray-400 dark:text-gray-600">|</span>
    ...
    <main class="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-6">Editar Modelo</h1>
            ...
            <form wire:submit="update">
                <div class="border border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="vehicleBrandId" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Marca</label>
                            <select
                                id="vehicleBrandId"
                                wire:model="vehicleBrandId"
                                class="w-full px-4 py-2 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                            >
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                    ...
                    <a
                        href="{{ route('vehicleModels.index') }}"
